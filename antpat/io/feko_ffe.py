...
class FEKOffe(object):
    ...
    def read(self, ffefile):
        ...
        for field in fieldsStr[1:]:
            ...
            # I repeatedly read the theta & phi values but they're
            # intentionally overwritten every new request block, so only the
            # last set is saved.
            ...
            self.Request[Request]._add_data(theta, phi, etheta, ephi, gtheta,
                                            gphi, gtotal)
